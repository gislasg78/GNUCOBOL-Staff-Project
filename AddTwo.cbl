       ...
       MAIN-PARAGRAPH.
           ...
           ADD ws-amount1 TO ws-amount2 GIVING ws-result
               ON SIZE ERROR
                  PERFORM DisplayErrorMessages

              NOT ON SIZE ERROR
                  PERFORM ProvideResultsInformation
       ...
       DisplayErrorMessages.
           ...
           DISPLAY SPACE
           DISPLAY "The calculation is too large to be stored in the "
                   "receiving variable."
           DISPLAY "The result size exceeds its definition size."
           DISPLAY "The original result value is respected: "
                   "[" ws-result "].".

       ProvideResultsInformation.
           DISPLAY SPACE
           DISPLAY "The calculation was satisfactory."
           ...
           DISPLAY SPACE
           DISPLAY "The result of their sum is: [" ws-result "].".
