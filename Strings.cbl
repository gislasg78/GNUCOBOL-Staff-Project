       ...
       01  ws-current-date-and-time-chains-formatted.
           03  ws-current-date-msg-formatted PIC X(40) VALUE SPACES.
       ...
       MAIN-PARAGRAPH.
           ...
           PERFORM 100000-begin-string-current-date
              THRU 100000-end-string-current-date

           PERFORM 200000-begin-inspect-current-date
              THRU 200000-end-inspect-current-date

           PERFORM 300000-begin-unstring-current-date
              THRU 300000-end-unstring-current-date
       ...
       100000-begin-string-current-date.
       ...
       100000-end-string-current-date.
           EXIT.

       200000-begin-inspect-current-date.
           ...
           DISPLAY SPACE.
       200000-end-inspect-current-date.
           EXIT.

       300000-begin-unstring-current-date.
               ...
               WITH POINTER  ws-date-pointer-unstring
                ...
                NOT ON OVERFLOW
                    DISPLAY "The target fields were successfully "
                            "constructed."
           END-UNSTRING.
       300000-end-unstring-current-date.
           EXIT.
